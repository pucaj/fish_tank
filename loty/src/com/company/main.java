...
public class main extends JFrame{
	...
	public static void main(String[] args){
		...
		*/
		...
		//R.initMap("map_1280x720.txt");
		map = new mapGUI(R.map.getDimension(),R.statki,R.map.budynki);
		controls = new controlsGUI(new Dimension(R.map.getWidth()*2, R.map.getHeight()));
		logs = new logsGUI(new Dimension(R.map.getWidth(),R.map.getHeight()));
